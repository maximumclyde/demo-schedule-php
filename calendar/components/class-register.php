...
<body>
    ...
    <div id="register-class-container" class="register-form-conainers">
        <form action="index.php" method="post" id="register-class-form">

            <div id="title-row" class="row">
                <input type="text" name="title-input" id="title-input" placeholder="Class name">
            ...
            <div id="week-frequency-row" class="row week-rep-row">
                <div id="inner-week-freq">
                    <span>This class repeats every </span>
            ...
            <div id="submit-row" class="row">
                <button type="submit" name="submit-class" class="submit">Save</button>
            </div>
        </form>
    </div>
